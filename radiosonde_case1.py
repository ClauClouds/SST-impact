...
def f_interpolation_sondes(height,var):
    ...
    f = interpolate.interp1d(height,var)
    y_new = f(height_interp)
    return(y_new)
...
rh_interp = np.zeros((n_soundings, dim_interp))
ta_interp = np.zeros((n_soundings, dim_interp))
wdir_interp = np.zeros((n_soundings, dim_interp))
wspd_interp = np.zeros((n_soundings, dim_interp))
lat_interp = np.zeros((n_soundings, dim_interp))
lon_interp = np.zeros((n_soundings, dim_interp))

flight_time_interp = np.zeros((n_soundings, dim_interp))
wvmr_interp.fill(np.nan)
p_interp.fill(np.nan)
rh_interp.fill(np.nan)
ta_interp.fill(np.nan)
wdir_interp.fill(np.nan)
wspd_interp.fill(np.nan)
lat_interp.fill(np.nan)
lon_interp.fill(np.nan)
flight_time_interp.fill(np.nan)
